    ...
    try {
        ...
        const _auditWasConcluido = (typeof _kbStatusIsConcluido === 'function' ? _kbStatusIsConcluido(originalItem ? originalItem.status : '') : /conclu/i.test(originalItem ? originalItem.status : ''));
